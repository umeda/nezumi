...
# Title: Throttled
# Generated: Sun May 16 09:20:41 2021
##################################################
...
class throttled(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Throttled")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Throttled")
        ...
        self.settings = Qt.QSettings("GNU Radio", "throttled")
        ...
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_char*1, "localhost", 5005, 1, True)
        ...
        self.connect((self.rational_resampler_xxx_1, 0), (self.blocks_float_to_uchar_0, 0))
...
def main(top_block_cls=throttled, options=None):
