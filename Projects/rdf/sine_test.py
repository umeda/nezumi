...
# Title: Two sines different phases
...
class sine_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Two sines different phases")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Two sines different phases")
        ...
        self.top_grid_layout.addWidget(self._shift_slider_win)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(complex(math.cos(shift_slider),math.sin(shift_slider)))
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, freq , 0.5, 0, 0)
